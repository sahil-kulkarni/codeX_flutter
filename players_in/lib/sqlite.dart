...
//       await db.execute(
//           "CREATE TABLE Player(name TEXT, jerNo TEXT)");
//     },
//   );
//   // PlayerModelClass p = PlayerModelClass(jerNo: 1, name: "KL", );
//   // PlayerModelClass p1 = PlayerModelClass(jerNo: 12, name: "virat", );
//   // await insertPlayer(d);
...
Future<void> insertPlayer(PlayerModelClass player) async {
  ...
  if (localDB == null) {
    print("Error: Database is null. Failed to insert data.");
    return;
  }
